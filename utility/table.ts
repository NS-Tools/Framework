...
export class Table {
     ...
     */
    constructor(private columns: Column[], private data: object[] | NetsuiteCurrentRecord[]) {
...
export class TableRender {
     ...
     */
    constructor(protected columns: Column[], protected data: object[]) {
...
class TableRenderHtml extends TableRender {
    ...
    private row(): string {
        return this.data.map(currentRow => {
            const rowString = this.columns.map(column => {
