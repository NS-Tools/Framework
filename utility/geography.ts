...
export const stateMapping: State[] = [
	{ shortname: '', fullname: '', country: '', id: 0 },
	{
		country: 'US',
		fullname: 'Alabama',
		id: 0,
 ...
 */
export const countryMapping: Country[] = [
	{
		uniquekey: 0,
		name: '',
		edition: '',
...
export function getCountryById(id: string) {
	const countries = countryMapping.filter((x) => x.id === id);
 ...
 */
export function getCountryByUniqueKey(uniquekey: number) {
	const countries = countryMapping.filter((x) => x.uniquekey === uniquekey);
